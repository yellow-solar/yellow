...
-- Schema CoreSolar
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS CoreSolar ;
USE CoreSolar ;

/* Drop tables */
DROP TABLE IF EXISTS CoreSolar.payments;
DROP TABLE IF EXISTS CoreSolar.accounts;
DROP TABLE IF EXISTS CoreSolar.clients;

-- -----------------------------------------------------
-- Table CoreSolar.clients
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS CoreSolar.clients (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS CoreSolar.accounts (
  -- Angaza fields
...
-- -----------------------------------------------------
-- Table CoreSolar.payments
-- -----------------------------------------------------
CREATE TABLE CoreSolar.payments (
